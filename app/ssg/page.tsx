...
// Sin revalidate = SSG puro, solo se actualiza con un nuevo build
        ...
        <>
            ...
            <div className="container">
                <div className="header">
                    <div className="title">🎀 Blog SSG</div>
                    <div className="subtitle">
                        Generado una sola vez al hacer build — no se actualiza hasta el próximo build
                    </div>
                </div>
